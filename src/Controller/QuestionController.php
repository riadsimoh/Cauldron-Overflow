...
class QuestionController extends AbstractController
{
    ...
    public function show($slug, MarkdownParserInterface $markdownParser, CacheInterface $cache)
    {
        ...
        $questionText = "I've been turnded into a cat, any thoughts on how to turn back? While I'm **adorable**, I don't really care for cat food.";
        $parsedQuestionText = $cache->get('markdown_' . md5($questionText), function () use ($markdownParser, $questionText) {
            return $parsedQuestionText = $markdownParser->transformMarkdown($questionText);
        });
